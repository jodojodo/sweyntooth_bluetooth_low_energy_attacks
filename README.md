...
The binary of our firmware code is on the `nRF52_driver_firmware.zip` file. You
...
We have made available a simple script to check what key sizes are acceptable
